...
.source.python .variable.parameter {
  ...
  <body class='markdown-preview' data-use-github-style><h1 id="pr-ctica-de-vnc">Práctica de VNC</h1>
<p>En esta práctica vamos a inicializar el VNC. Para ello primero necesitamos instalar una máquina OpenSUSE.</p></body>
</html>
